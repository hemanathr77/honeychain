-- HoneyChain — PostgreSQL Schema
-- ====================================================
-- Run this file manually to initialize the database:
--   psql -U postgres -d honeychain -f schema.sql
--
-- OR let the backend auto-initialize on startup.
-- The backend runs CREATE TABLE IF NOT EXISTS, so
